    ...
    if ($page == "formdoc") {
        ...
        if (isset($start) || isset($end)) {
            try {
                ...
                $sql->bindParam(':login_id', $_SESSION['staff_id'], PDO::PARAM_INT);
...
?>
        ...
        <body class="menu">
            ...
            <form method="post" action="/stf/time_insert.php?id=formdoc">
                <table border="1">
        ...
        <br>
        <footer id="footer">
            <button type="button" onclick="location.href='../admin/mykintai_list.php'">一覧に戻る</button>
